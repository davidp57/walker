 ...
 * is picked, mirroring how the Fortnight "add in cell" flow prefills from the most recent comment
 * on that cell (see `openAddInCell` in `App.tsx`). Ordered by recency: latest date, then latest
 * start-of-day wins.
 */
